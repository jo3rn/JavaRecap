 ...
 * Falls das auch nicht der Fall ist, gewinnt man zumindest 1 EUR, wenn alle drei Zahlen unterschiedlich sind.
 * In allen anderen Fällen beträgt der Gewinn 0 EUR.
 * Schreiben Sie die Methode public static int tombola(int a, int b, int c), welche den Gewinn
 * für eine gegebene Ziffernfolge eines Loses zurückliefert.
 *
 * Beispiele:
 * tombola(3, 3, 3) -> 10
 * tombola(9, 9, 9) -> 5
